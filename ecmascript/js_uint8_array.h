...
#ifndef PANDA_RUNTIME_ECMASCRIPT_JS_UINT8_ARRAY_H
#define PANDA_RUNTIME_ECMASCRIPT_JS_UINT8_ARRAY_H
...
class JSUint8Array : public JSObject {
public:
    static JSUint8Array *Cast(ObjectHeader *object)
    {
        ASSERT(JSTaggedValue(object).IsJSUint8Array());
        return static_cast<JSUint8Array *>(object);
    }
...
#endif  // PANDA_RUNTIME_ECMASCRIPT_JS_UINT8_ARRAY_H