...
#ifndef ECMASCRIPT_MODULE_NAMESPACE_H
#define ECMASCRIPT_MODULE_NAMESPACE_H
...
public:
    ...
    static JSHandle<ModuleNamespace> ModuleNamespaceCreate(JSThread *thread, JSHandle<JSTaggedValue> module,
    ...
    static OperationResult GetProperty(JSThread *thread, JSHandle<JSTaggedValue> obj, JSHandle<JSTaggedValue> key);
    ...
    bool ValidateKeysAvailable(JSThread *thread, JSHandle<TaggedArray> &exports);
...
#endif  // ECMASCRIPT_MODULE_NAMESPACE_H
