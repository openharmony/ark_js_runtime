...
JSHandle<ModuleNamespace> ModuleNamespace::ModuleNamespaceCreate(JSThread *thread, JSHandle<JSTaggedValue> module,
                                                                 JSHandle<TaggedArray> exports)
{
    ...
    JSHandle<JSTaggedValue> fn(thread, globalConst->GetUndefined());
    ...
    JSHandle<JSTaggedValue> moduleString(thread, globalConst->GetModuleString());
...
OperationResult ModuleNamespace::GetProperty(JSThread *thread, JSHandle<JSTaggedValue> obj, JSHandle<JSTaggedValue> key)
{
    ...
    JSHandle<JSTaggedValue> binding = mm->ResolveExport(thread, key, resolveSet);
    ...
    JSTaggedValue result =
        SourceTextModule::Cast(targetModule.GetHeapObject())->GetModuleValue(thread, resolvedBind->GetBindingName(), true);
...
bool ModuleNamespace::ValidateKeysAvailable(JSThread *thread, JSHandle<TaggedArray> &exports)
{
