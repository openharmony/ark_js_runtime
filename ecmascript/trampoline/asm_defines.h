...
#define ASM_INTERPRETED_FRAME_STATE_SIZE       (64)
#define ASM_INTERPRETED_FRAME_FUNCTION_OFFSET  (0)
#define ASM_INTERPRETED_FRAME_ACC_OFFSET       (8)
#define ASM_INTERPRETED_FRAME_ENV_OFFSET       (16)
#define ASM_INTERPRETED_FRAME_CALL_SIZE_OFFSET (24)
#define ASM_INTERPRETED_FRAME_FP_OFFSET        (32)
#define ASM_INTERPRETED_FRAME_PC_OFFSET        (40)
#define ASM_INTERPRETED_FRAME_PREV_SP_OFFSET   (48)
