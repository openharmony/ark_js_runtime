 ...
 */
    ...
    {
        NOTIFY_DEBUGGER_EVENT();
        REAL_GOTO_DISPATCH_OPCODE(EcmaOpcode::IMPORTMODULE_PREF_ID32);
    }
    ...
    HANDLE_OPCODE(DEBUG_HANDLE_LDMODVARBYNAME_PREF_ID32_V8)
    {
        NOTIFY_DEBUGGER_EVENT();
        REAL_GOTO_DISPATCH_OPCODE(EcmaOpcode::LDMODVARBYNAME_PREF_ID32_V8);
    }
