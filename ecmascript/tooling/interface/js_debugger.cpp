...
{
    auto localEvalFunc = [](const EcmaVM *ecmaVm, FrameHandler *frameHandler, int32_t regIndex,
...
{
    auto localEvalFunc = [](const EcmaVM *, FrameHandler *frameHandler, int32_t regIndex,
