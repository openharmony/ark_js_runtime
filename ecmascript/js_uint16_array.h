...
#ifndef PANDA_RUNTIME_ECMASCRIPT_JS_UINT16_ARRAY_H
#define PANDA_RUNTIME_ECMASCRIPT_JS_UINT16_ARRAY_H
...
class JSUint16Array : public JSObject {
public:
    static JSUint16Array *Cast(ObjectHeader *object)
    {
        ASSERT(JSTaggedValue(object).IsJSUint16Array());
        return static_cast<JSUint16Array *>(object);
    }
...
#endif  // PANDA_RUNTIME_ECMASCRIPT_JS_UINT16_ARRAY_H