...
#ifndef PANDA_RUNTIME_ECMASCRIPT_TAGGED_HASH_TABLE_INL_H
#define PANDA_RUNTIME_ECMASCRIPT_TAGGED_HASH_TABLE_INL_H
...
#endif  // PANDA_RUNTIME_ECMASCRIPT_TAGGED_HASH_TABLE_INL_H
