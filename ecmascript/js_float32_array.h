...
#ifndef PANDA_RUNTIME_ECMASCRIPT_JS_FLOAT32_ARRAY_H
#define PANDA_RUNTIME_ECMASCRIPT_JS_FLOAT32_ARRAY_H
...
class JSFloat32Array : public JSObject {
public:
    static JSFloat32Array *Cast(ObjectHeader *object)
    {
        ASSERT(JSTaggedValue(object).IsJSFloat32Array());
        return static_cast<JSFloat32Array *>(object);
    }
...
#endif  // PANDA_RUNTIME_ECMASCRIPT_JS_FLOAT32_ARRAY_H
