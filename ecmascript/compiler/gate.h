...
// | prev=null      | prev=null      | ...                |           |           |
// | idx=1          | idx=0          |                    |    g0     |    g1     |
// | next=g4.out[2] | next=g4.out[1] | firstOut=g4.out[0] |           |           |
// |                |                |                    |           |           |
// +----------------+----------------+--------------------+-----------+-----------+
//       /\               /\
//       ||               ||
...
// |                |                |                |                    |           |           |           |
// | prev=g2.out[1] | prev=g2.out[0] | prev=null      | ...                |           |           |           |
// | idx=2          | idx=1          | idx=0          |                    |    g2     |    g0     |    g1     |
// | next=null      | next=null      | next=g3.out[0] | firstOut=g5.out[1] |           |           |           |
// |                |                |                |                    |           |           |           |
// +----------------+----------------+----------------+--------------------+-----------+-----------+-----------+
// ```
