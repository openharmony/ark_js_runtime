...
HWTEST_F_L0(DebuggerTypesTest, SamplingHeapProfileSampleCreateTest)
{
    ...
    //  abnormal params of null msg
    msg = std::string() + R"({})";
    object = SamplingHeapProfileSample::Create(DispatchRequest(ecmaVm, msg).GetParams());
...
HWTEST_F_L0(DebuggerTypesTest, SamplingHeapProfileSampleToJsonTest)
{
    ...
    msg = std::string() + R"({"id":0,"method":"Debugger.Test","params":{"size":100,"nodeId":1,"ordinal":10}})";
    samplingHeapProfileSampleData =
        SamplingHeapProfileSample::Create(DispatchRequest(ecmaVm, msg).GetParams());
    ASSERT_NE(samplingHeapProfileSampleData, nullptr);
...
HWTEST_F_L0(DebuggerTypesTest, SamplingHeapProfileNodeCreateTest)
{
    ...
    //  abnormal params of null msg
    msg = std::string() + R"({})";
    object = SamplingHeapProfileNode::Create(DispatchRequest(ecmaVm, msg).GetParams());
    EXPECT_EQ(object, nullptr);
...
HWTEST_F_L0(DebuggerTypesTest, SamplingHeapProfileNodeToJsonTest)
{
    ...
    samplingHeapProfileNode = SamplingHeapProfileNode::Create(DispatchRequest(ecmaVm, msg).GetParams());
    ASSERT_NE(samplingHeapProfileNode, nullptr);
...
HWTEST_F_L0(DebuggerTypesTest, SamplingHeapProfileCreateTest)
{
    ...
    //  abnormal params of null msg
    msg = std::string() + R"({})";
    object = SamplingHeapProfile::Create(DispatchRequest(ecmaVm, msg).GetParams());
    EXPECT_EQ(object, nullptr);
...
HWTEST_F_L0(DebuggerTypesTest, SamplingHeapProfileToJsonTest)
{
    ...
    samplingHeapProfile = SamplingHeapProfile::Create(DispatchRequest(ecmaVm, msg).GetParams());
    ASSERT_NE(samplingHeapProfile, nullptr);
...
HWTEST_F_L0(DebuggerTypesTest, PositionTickInfoCreateTest)
{
    ...
    //  abnormal params of null msg
    msg = std::string() + R"({})";
    positionTickInfo = PositionTickInfo::Create(DispatchRequest(ecmaVm, msg).GetParams());
...
HWTEST_F_L0(DebuggerTypesTest, ProfileNodeCreateTest)
{
    ...
    //  abnormal params of null msg
    msg = std::string() + R"({})";
    profileNode = ProfileNode::Create(DispatchRequest(ecmaVm, msg).GetParams());
...
HWTEST_F_L0(DebuggerTypesTest, ProfileCreateTest)
{
    ...
    //  abnormal params of null msg
    msg = std::string() + R"({})";
    profile = Profile::Create(DispatchRequest(ecmaVm, msg).GetParams());
...
HWTEST_F_L0(DebuggerTypesTest, CoverageCreateTest)
{
    ...
    //  abnormal params of null msg
    msg = std::string() + R"({})";
    coverage = Coverage::Create(DispatchRequest(ecmaVm, msg).GetParams());
...
HWTEST_F_L0(DebuggerTypesTest, FunctionCoverageCreateTest)
{
    ...
    //  abnormal params of null msg
    msg = std::string() + R"({})";
    functionCoverage = FunctionCoverage::Create(DispatchRequest(ecmaVm, msg).GetParams());
...
HWTEST_F_L0(DebuggerTypesTest, ScriptCoverageCreateTest)
{
    ...
    //  abnormal params of null msg
    msg = std::string() + R"({})";
    scriptCoverage = ScriptCoverage::Create(DispatchRequest(ecmaVm, msg).GetParams());
