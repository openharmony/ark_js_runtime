...
#ifndef PANDA_RUNTIME_ECMASCRIPT_JS_UINT8_CLAMPED_ARRAY_H
#define PANDA_RUNTIME_ECMASCRIPT_JS_UINT8_CLAMPED_ARRAY_H
...
class JSUint8ClampedArray : public JSObject {
public:
    static JSUint8ClampedArray *Cast(ObjectHeader *object)
    {
        ASSERT(JSTaggedValue(object).IsJSUint8ClampedArray());
        return static_cast<JSUint8ClampedArray *>(object);
    }
...
#endif  // PANDA_RUNTIME_ECMASCRIPT_JS_UINT8_CLAMPED_ARRAY_H