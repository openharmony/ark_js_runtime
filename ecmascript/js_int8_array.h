...
#ifndef PANDA_RUNTIME_ECMASCRIPT_JS_INT8_ARRAY_H
#define PANDA_RUNTIME_ECMASCRIPT_JS_INT8_ARRAY_H
...
class JSInt8Array : public JSObject {
public:
    static JSInt8Array *Cast(ObjectHeader *object)
    {
        ASSERT(JSTaggedValue(object).IsJSInt8Array());
        return static_cast<JSInt8Array *>(object);
    }
...
#endif  // PANDA_RUNTIME_ECMASCRIPT_JS_INT8_ARRAY_H
