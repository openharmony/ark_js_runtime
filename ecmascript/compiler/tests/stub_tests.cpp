...
#undef DEF_FAST_STUB
    ...
    JSTaggedValue JSFunction(uintptr_t stubAddr, uintptr_t sp, int argc, const JSTaggedType argv[])
    {
        JSTaggedValue res(JSFunctionEntry(thread->GetGlueAddr(),
            sp, argc, argc, argv, stubAddr));
        return res;
    }
