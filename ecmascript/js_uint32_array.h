...
#ifndef PANDA_RUNTIME_ECMASCRIPT_JS_UINT32_ARRAY_H
#define PANDA_RUNTIME_ECMASCRIPT_JS_UINT32_ARRAY_H
...
class JSUint32Array : public JSObject {
public:
    static JSUint32Array *Cast(ObjectHeader *object)
    {
        ASSERT(JSTaggedValue(object).IsJSUint32Array());
        return static_cast<JSUint32Array *>(object);
    }
...
#endif  // PANDA_RUNTIME_ECMASCRIPT_JS_UINT32_ARRAY_H