...
public:
    ...
    using ObjectUpdaterFunc =
        std::function<void(const FrameHandler *, std::string_view, const Local<JSValueRef> &)>;
    ...
    void NotifyLocalScopeUpdated(std::string_view varName, const Local<JSValueRef> &value)
    {
