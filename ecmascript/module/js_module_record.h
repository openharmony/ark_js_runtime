...
#ifndef ECMASCRIPT_JS_MODULE_RECORD_H
#define ECMASCRIPT_JS_MODULE_RECORD_H
...
public:
    ...
    static int32_t Instantiate(JSThread *thread, JSHandle<JSTaggedValue> module);
    // 15.2.1.16.5 Evaluate()
    static int32_t Evaluate(JSThread *thread, JSHandle<JSTaggedValue> module);
