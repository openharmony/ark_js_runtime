...
#ifndef PANDA_RUNTIME_ECMASCRIPT_JS_INT16_ARRAY_H
#define PANDA_RUNTIME_ECMASCRIPT_JS_INT16_ARRAY_H
...
class JSInt16Array : public JSObject {
public:
    static JSInt16Array *Cast(ObjectHeader *object)
    {
        ASSERT(JSTaggedValue(object).IsJSInt16Array());
        return static_cast<JSInt16Array *>(object);
    }
...
#endif  // PANDA_RUNTIME_ECMASCRIPT_JS_INT16_ARRAY_H
