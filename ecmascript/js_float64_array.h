...
#ifndef PANDA_RUNTIME_ECMASCRIPT_JS_FLOAT64_ARRAY_H
#define PANDA_RUNTIME_ECMASCRIPT_JS_FLOAT64_ARRAY_H
...
class JSFloat64Array : public JSObject {
public:
    static JSFloat64Array *Cast(ObjectHeader *object)
    {
        ASSERT(JSTaggedValue(object).IsJSFloat64Array());
        return static_cast<JSFloat64Array *>(object);
    }
...
#endif  // PANDA_RUNTIME_ECMASCRIPT_JS_FLOAT64_ARRAY_H
